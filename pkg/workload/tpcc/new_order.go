...
var _ tpccTx = &newOrderRead{}

func createNewOrderRead(
	ctx context.Context, config *tpcc, mcp *workload.MultiConnPool,
) (tpccTx, error) {
	n := &newOrderRead{
		config: config,
	...
	if err := n.sr.Init(ctx, "new-order-read", mcp); err != nil {
		return nil, err
	}
...
var _ tpccTx = &newOrderWrite{}

func createNewOrderWrite(
	ctx context.Context, config *tpcc, mcp *workload.MultiConnPool,
) (tpccTx, error) {
	n := &newOrderWrite{
		config: config,
	...
	if err := n.sr.Init(ctx, "new-order-write", mcp); err != nil {
		return nil, err
	}
...
func (n *newOrderRead) run(ctx context.Context, wID int) (interface{}, error) {
	atomic.AddUint64(&n.config.auditor.newOrderTransactions, 1)
...
func (n *newOrderWrite) run(ctx context.Context, wID int) (interface{}, error) {
	atomic.AddUint64(&n.config.auditor.newOrderTransactions, 1)
